					...
					<Card className="border-0 bg-gradient-to-r from-blue-600 to-indigo-700 text-white overflow-hidden">
						<CardHeader className="relative">
							...
							<CardDescription className="text-blue-100 text-lg">
								Continue building lasting spiritual habits through the COST
								framework
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="flex items-center gap-6">
								<div className="flex items-center gap-2">
									...
									<span>Day 23 of Discipleship</span>
								</div>
								<div className="flex items-center gap-2">
					...
					<div className="lg:col-span-2 space-y-6">
						...
						<Card className="shadow-sm hover:shadow-md transition-shadow">
							<CardHeader>
								...
								<CardDescription>
									Complete these activities to stay on track
								</CardDescription>
							</CardHeader>
							<CardContent>
