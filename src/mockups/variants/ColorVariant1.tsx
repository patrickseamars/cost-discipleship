  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#fefcf9' }}>
        ...
        <div className="max-w-6xl mx-auto p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link to="/mockups">
                <Button variant="ghost" size="sm" className="gap-2 warm-text-primary hover:warm-muted-bg">
                  <ArrowLeft className="w-4 h-4" />
                  Back to Hub
                </Button>
              </Link>
              <div className="h-6 w-px" style={{ backgroundColor: '#d2b48c' }} />
              <div>
                <h1 className="text-2xl font-bold warm-text-primary">
                  COST Training - Warm Tones
                </h1>
                <p className="text-sm warm-text-secondary">Earth-inspired spiritual journey</p>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          <Card className="border-0 overflow-hidden warm-card-bg shadow-lg">
            <div className="warm-primary text-white p-8 relative">
              ...
              <CardTitle className="text-3xl mb-3 font-serif">Welcome to Your Spiritual Journey</CardTitle>
              <CardDescription className="text-orange-100 text-lg">
                Walking the path of discipleship with warmth, wisdom, and community
              </CardDescription>
        ...
        {/* COST Framework */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold warm-text-primary mb-6 font-serif">The COST Framework</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="warm-card-bg border warm-border hover:shadow-md transition-shadow">
              <CardHeader className="text-center">
                ...
                <CardTitle className="warm-text-primary font-serif">Connect</CardTitle>
            ...
            <Card className="warm-card-bg border warm-border hover:shadow-md transition-shadow">
              <CardHeader className="text-center">
                ...
                <CardTitle className="warm-text-primary font-serif">Obey</CardTitle>
                <CardDescription className="warm-text-secondary">
            ...
            <Card className="warm-card-bg border warm-border hover:shadow-md transition-shadow">
              <CardHeader className="text-center">
                ...
                <CardTitle className="warm-text-primary font-serif">Share</CardTitle>
                <CardDescription className="warm-text-secondary">
            ...
            <Card className="warm-card-bg border warm-border hover:shadow-md transition-shadow">
              <CardHeader className="text-center">
                ...
                <CardTitle className="warm-text-primary font-serif">Train</CardTitle>
                <CardDescription className="warm-text-secondary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 rounded-lg warm-muted-bg">
                    <h4 className="font-semibold warm-text-primary mb-2">Scripture Focus</h4>
                    ...
                    <p className="text-sm warm-text-secondary mt-1">- Philippians 3:8</p>
                  </div>
                  
                  <div className="p-4 rounded-lg warm-muted-bg">
                    <h4 className="font-semibold warm-text-primary mb-2">Reflection Question</h4>
                    <p className="warm-text-secondary">
                      What does it mean to you to "know Christ Jesus" beyond just knowing about Him?
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <div>
            <Card className="warm-card-bg border warm-border">
              <CardHeader>
                <CardTitle className="warm-text-primary font-serif">Your Progress</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-center">
                  <div className="text-3xl font-bold warm-text-primary">Day 12</div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant="outline" className="warm-border warm-text-secondary">30%</Badge>
                  </div>
                </div>
        ...
        {/* Inspirational Quote */}
        <div className="mt-8">
          <Card className="border-0 text-center py-8" style={{ background: 'linear-gradient(135deg, #f5f0e8, #ede0d3)' }}>
            <CardContent>
